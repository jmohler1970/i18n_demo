...
* @File:          		pl_PL.php
* @GetSimple Version:   3.4.x
* @Creation Date: 		14 Sep 2018
* @Revision:	    	14 Jul 2018
...
"TZ_WARNING"			=>	"<strong>Ostrzeżenie:</strong> <em>date_default_timezone_set</em> nie został ustawiony", //no more used in gs 3.4
...
"LABEL_SITEABOUT"       =>	"Dodatkowe notatki o tej stronie",
...
"EXPAND_TOP"              =>	"Rozwiń Nadrzędne Strony",
"COLLAPSE_TOP"            =>	"Zwiń Nadrzędne Strony",
"MISSING_PARENT"          =>    " - <i>Brakująca str.nadrzędna</i>",
"EDITING_PAGE_TITLE"      =>	"Edytujesz stronę: %s",

// drafts
"EDITING_DRAFT_TITLE"     =>	"Edycja wersji roboczej: %s",
"LABEL_DRAFT"             =>	"WERSJA ROBOCZA",
"DRAFT_LAST_SAVED"        =>	"Wersja robocza zapisana przez <em>%s</em> ",
"PUBLISH"                 =>	"Publikuj",
"LABEL_PUBLISHED"         =>	"OPUBLIKOWANO",
"PAGE_NO_DRAFT"           =>    "Strona nie posiada wersji roboczej",
...
"FILE_EXISTS_PROMPT"    =>    "Plik istnieje, Nadpisać?",
"FILES"                 =>    "plików",
...
"THEME_ROOT"        =>  "Pliki konfiguracyjne",
"UNSAVED_PROMPT"    =>  "Na stronie wprowadzono niezapisane zmiany, kontynuować mimo to ?",
...
"VIEW_LOG_FILE"     =>	"Podgląd plików logu",
...
"DATE"					=>	"Data",
"PERMS"					=>  "Zezwolenia",
"RESTOREERROR"          =>  "Przywrócenie kopii nie powiodło się",
...
"ACTIVE"                =>	"Aktywny",
"COMPONENT_DELETED"     =>  "Komponent zostanie usunięty podczas następnego zapisu <b>%s</b>",

/* 
* For: snippets.php
*/
"SNIPPETS"                =>	"Snippety",
"DELETE_SNIPPET"          =>	"Usuń Snippet",
"EDIT"                    =>	"Edytuj",
"ADD_SNIPPET"             =>	"Dod<em>a</em>j Snippet", // 'a' is the accesskey identifier
"SAVE_SNIPPETS"           =>	"Zapisz Snippety",
...
"SITEMAP_ERRORPING"		=>	"Mapa strony została utworzona, ale wystąpił błąd pingowania serwisów wyszukiwania",
"SITEMAP_WAIT"			=>	"<strong>Proszę czekać:</strong> trwa generowanie mapy strony (sitemap.xml)",
"SITEMAP_ERROR"			=>	"<strong>Ostrzeżenie:</strong> mapa strony nie mogła zostać wygenerowana",
"SITEMAP_REFRESHED"     =>	"Mapa strony została odświeżona",
"VIEW_SITEMAP"          =>  "Zobacz mapę strony",
...
"URL_SETTINGS"          =>  "Ustawienia adresów <abbr title=\"Uniform Resource Locator\">URL</abbr>",
...
"PROVIDE_PASSWORD"      =>	"Musisz wprowadzić hasło",
...
"PASSWORD_TOO_SHORT"    =>    "Wprowadzone hasło jest za krótkie",
...
"GOOD_FILE"             =>	"Prawidłowy", /*"Good file",*/
"CANNOT_DEL_FILE"		=>	"Nie można usunąć pliku",
"DOWNLOAD"			  	=>	"Ściągnij",
"WRITABLE"		  		=>	"Zapisywalny",
"NOT_WRITABLE"			=>	"Nie zapisywalny! ",
"NA"                 	=>	"<abbr title=\"Niedostępny\">N/A</abbr>",
"DEBUG_INFO"            =>  "Tryb debugowania jest włączony, więcej informacji jest dostępnych na ",
...
"ARCHIVE_DL_DISABLED"   =>	"Pobieranie archiwów zostało wyłączone",
...
"TAB_SNIPPETS"      =>	"Snippety",
"TAB_THEME-EDIT"    =>	"Edytor szablonów",
"TAB_EDIT"          =>	"Nowa strona",
"TAB_MENU-MANAGER"  =>	"Menu",
"TAB_SITEMAP"       =>	"Mapa strony",
"TAB_BACKUPS"       =>	"Backupy",
"TAB_ARCHIVE"       =>	"Archiwa",
"TAB_SUPPORT"       =>	"Pomoc",
"TAB_HEALTH-CHECK"  =>	"Stan działania",
"TAB_LOG"           =>	"Logi",
"TAB_PROFILE"       =>	"Profil",

"PLUGINS_NAV" 		=>  "Wtyczki", // legacy
"TAB_FILES"			=>	"Pliki", // legacy
...
"UPLOAD"			=>	"Wczytaj",
"DROP_FILES"        =>	"Przeciągnij pliki tutaj</br><small>(lub kliknij)</small>",
...
"SIDE_USER_PROFILE"		=>	"Profil <em>U</em>żytkownika",

/* 
 * For: sidebar-backups.php
*/
"SIDE_VIEW_BAK"			=>	"Zobacz kopie zapasowe strony",
"SIDE_WEB_ARCHIVES"		=>	"Archiwum witryny",
...
"ER_SNIPPET_SAVE"		=>	"Twoje snippety zostały zapisane",
"ER_SNIPPET_REST"       =>	"Twoje snippety zostały przywrócone",
"ER_CANCELLED_FAIL"		=>	"<strong>Rezygnacja:</strong> Aktualizacja tego pliku została anulowana",
"ER_PUBLISH_SUCCESS"  	=>	"Wersja robocza <b>%s</b> została opublikowana",
"ER_PUBLISH_ERROR"    	=>	"Wystąpił problem podczas publikacji wersji roboczej <b>%s</b>",
"ER_SAFEMODE"         	=>    "Tryb awaryjny jest aktywny",
"ER_SAFEMODE_DISALLOW"	=>    "Niedozwolona operacja w trybie awaryjnym",
...
*/
"FTYPE_COMPRESSED"	=>	"Skompresowane", // file-type archive
"FTYPE_VECTOR"    	=>	"Wektorowe",     // file-type vector
...
"FTYPE_DOCUMENT"  	=>	"Dokumenty",   // file-type document
"FTYPE_SYSTEM"    	=>	"System",     // file-type system file
"FTYPE_MISC"      	=>	"Różne",       // file-type Miscellaneous
"FTYPE_IMAGE"     	=>	"Obrazy",      // file-type image
"FTYPE_SCRIPT"    	=>	"Skrypty",     // file-type script
"IMAGES"			=>	"Obrazy",		// Legacy for GS < 3.4	
"FTYPE_DOCUMENTS" 	=>	"Dokumenty",  // LEGACY file-type document, do not use
...
*/
"LOCALE"                  =>	"pl_PL",           // locale to use
"DATE_FORMAT"             =>	"j.m.Y",          // short date only format
"DATE_AND_TIME_FORMAT"    =>	"j.m.Y - G:i", // date and time format
"TIME_FORMAT"             =>	"G:i",           // time only format
/***********************************************************************************
 * SINCE Version 2.0
***********************************************************************************/
/* For: support.php 
...
"CSRF"                  =>  "Wykryto atak <abbr title=\"Cross-site request forgery\">CSRF</abbr>",
/* 
 * For: image.php
*/
...
"CROP_TOGGLE_INPUTS"	=> "Pokaż / Ukryj zaawansowane ustawienia",
...
"EDIT_SNIPPETS"         =>	"Edytuj Snippety", //snippets
...
//"ITEMS" 				=> "plików", //upload.php //moved to generics words
...
"MINIMIZENOTIFY"  		=> "Edytujesz w trybie pełnego ekranu, F11 lub ESC aby zminimalizować",
...
"COPY_SUCCESS"            =>    "Skopiowano %s",
"COPY_FAILURE"            =>    "Nie udało się skopiować %s",
"IS_MISSING"              =>	"%s is missing",
"NOT_FOUND"               =>	"%s nie odnaleziono",
"NOT_SET"                 =>	"%s nie został ustawiony",
"TITLE"                   =>	"Tytuł",
"DELETE"                  =>	"Usuń",
"REMOVE"                  =>	"Remove",
"REMOVED"                 =>	"Removed",
...
"INACTIVATED"             =>	"Niekatywowany",
"SERVER"                  =>	"Serwer",
"CANCELLED"               =>    "Anylowany",
"PERMITTED"               =>    "Dopuszczony",
"NOT_PERMITTED"           =>    "Niedopuszczony",
"ALLOW"                   =>    "Zazwól",
"ALLOWED"                 =>    "Zezwolony",
...
"INVALID_OPER"            =>    "Nieprawodłowa operacja",
